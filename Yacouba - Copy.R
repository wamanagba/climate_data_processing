...
#### Read Precip data
S= stack(paste0(basepath,"mrt_tamsat.nc") )#S= crop(stack(paste0(basepath,"Tamsat_complet_Precipitation_Burkina.nc"), extent(shp)) )
x=crop(S,extent(shp))
...
colnames(mon_clim)[3:15]=shp$NAME_1
